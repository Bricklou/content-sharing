...
class User(AbstractUser):
    ...
    avatar = models.ImageField(upload_to=user_directory_path, default=None, storage=OverwriteStorage())
    ...
    def avatar_tag(self):
        if self.avatar != "":
            return mark_safe('<img src="/storage/%s" style="border-radius: 999px;" width="50" height="50" />' % self.avatar)
        return "-"
